...
| Acorn ADFS / FileCore | Auto / String | Yes | Yes (new-map E/F/HD) | Yes (`--fs adfs`, E-format) | N/A (fixed floppy) | check+repair (new-map) | Acorn Archimedes, BBC Master, RISC OS. D-format old-map write still open |
