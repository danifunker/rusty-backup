...
|---|---|---|---|---|---|---|---|
| FAT12 / FAT16 / FAT32 | Auto | Yes | Yes | Yes | Yes (in-place + defrag) | validate | DOS, Windows 3.x/9x, MSX, universal |
| exFAT | Auto | Yes | Yes | Yes | Yes (in-place + defrag clone) | validate | Modern removable media, large SD/CF |
