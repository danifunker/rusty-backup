...
| Minix (V1/V2/V3) | Yes  | No   | —               | —    | Minix, and Linux's original filesystem (pre-ext). Read-only browse of all three on-disk generations: V1 (magic 0x137F/0x138F, 14/30-char names), V2 (0x2468/0x2478), V3 (0x4D5A, 60-char names). Auto-detected as a raw floppy / hard-disk superfloppy or MBR type 0x81. |
