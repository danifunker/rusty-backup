...
| VMDK (Sparse) | `.vmdk` | None | No       | Read + write (`monolithicSparse`, `KDMV` magic). Two-level grain map; zero grains omitted on write, read back as zeros. Edit in 4.3. |
